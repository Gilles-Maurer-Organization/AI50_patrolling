...
def move_player(number_player, data, time_data, direction):
    ...
    if number_player == 1 :
        ...
        data[player_pos2[1]][player_pos2[0]] = 3
...
def main():
    ...
    player_pos2 = find_initial_position(data)
    if not player_pos:
        pygame.quit()
        sys.exit()
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_UP:
                    move_player(1, data, time_data, "UP")
                elif event.key == pygame.K_DOWN:
                    move_player(1, data, time_data, "DOWN")
                elif event.key == pygame.K_LEFT:
                    move_player(1, data, time_data, "LEFT")
                elif event.key == pygame.K_RIGHT:
                    move_player(1, data, time_data, "RIGHT")
                
                if event.key == pygame.K_z:
                    move_player(2, data, time_data, "UP")
                elif event.key == pygame.K_s:
                    move_player(2, data, time_data, "DOWN")
                elif event.key == pygame.K_q:
                    move_player(2, data, time_data, "LEFT")
                elif event.key == pygame.K_d:
                    move_player(2, data, time_data, "RIGHT")
