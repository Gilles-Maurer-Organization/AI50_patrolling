...
class AlignmentCheckBoxController(CheckBoxController):
    """
    This class manages the alignment checkbox, inheriting from CheckBoxController.
    ...
    def on_state_change(self) -> None:
        ...
        self._graph_controller.enable_snapping(self._check_box.enabled)