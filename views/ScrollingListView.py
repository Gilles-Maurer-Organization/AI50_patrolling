...
class ScrollingListView:
    ...
    def draw(self, algorithms: list[IAlgorithmModel], selected_algorithm = None, has_an_algorithm_selected: bool = False) -> None:
        '''
    ...
    def draw_options(self, algorithms: list[IAlgorithmModel]) -> None:
        '''
